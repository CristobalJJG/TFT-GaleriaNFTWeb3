...
\input{./1.-Introduccion/Introduccion.tex}
\newpage
%----Competencias----%
\chapter{Competencias específicas}
\input{./2.-Competencias/2.1-Competencias.tex}
\newpage
%----Estado actual y Objetivos iniciales----%
%--Objetivos iniciales/Estado actual--%
\chapter{Objetivos iniciales y estado actual}
\input{./3.-Objetivos_estado/3.-Objetivos.tex}
\newpage
%----Fin de introducción----%
%----Desarrollo como concepto----%
\chapter{Marco teórico}
\input{./4.-Marco-Teorico/marco-teorico.tex}
\newpage

\chapter{Estado del Arte}
\input{./5.-Estado-arte/5.-Estado-arte.tex}
\newpage
\chapter{Recursos y tecnologías}
\input{6.-Recursos-tecs/6.-Recursos.tex}
\newpage
